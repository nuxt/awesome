...
- [ScaleChamp](https://www.scalechamp.com/) - multi-cloud managed databases provider with Redis, KeyDB, PostgreSQL and MySQL support across Hetzner, AWS, Linode, IBM, Azure, Scaleway, Alibaba Cloud, DigitalOcean, GCP and UpCloud
